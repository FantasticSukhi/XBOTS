...
HELP_STRING = f"★ 𝙈𝙖𝙢𝙗𝙖 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @CREATIVITY_MAMBA**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/THE_THIRD_EYE_NETWORK"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/TELE_WALI_FRIENDSHIP")
    ]
  ]
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Mamba Bots !! @THE_THIRD_EYE_NETWORK", cache_time=0, alert=True)
